...
static const GSpixelFormat convert_format_dx10(DWORD format)
{
	...
	static const struct {
		...
		{ DDSFile::DXGI_FORMAT_BC6H_UF16, GS_FORMAT_BC6H_UF16 },
		{ DDSFile::DXGI_FORMAT_BC6H_SF16, GS_FORMAT_BC6H_SF16 },
		{ DDSFile::DXGI_FORMAT_BC7_UNORM, GS_FORMAT_FORMAT_BC7_UNORM },
		{ DDSFile::DXGI_FORMAT_BC7_UNORM_SRGB, GS_FORMAT_FORMAT_BC7_UNORM_SRGB },
	};
	// フォーマット変換
