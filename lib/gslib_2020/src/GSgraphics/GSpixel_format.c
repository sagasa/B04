...
const GSpixelFormat GS_FORMAT_BC6H_UF16                  = { GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_ARB, GL_RGB, GL_HALF_FLOAT, 16, GL_TRUE };
const GSpixelFormat GS_FORMAT_BC6H_SF16                  = { GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT_ARB, GL_RGB, GL_HALF_FLOAT, 16, GL_TRUE };
const GSpixelFormat GS_FORMAT_FORMAT_BC7_UNORM           = { GL_COMPRESSED_RGBA_BPTC_UNORM_ARB, GL_RGBA, GL_UNSIGNED_BYTE, 16, GL_TRUE };
const GSpixelFormat GS_FORMAT_FORMAT_BC7_UNORM_SRGB      = { GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM_ARB, GL_RGBA, GL_UNSIGNED_BYTE, 16, GL_TRUE };
