...
#    define WINGDIAPI /* 変更 __declspec(dllimport) */
#   endif
#  endif
...
#    ifdef _MT
#     ifdef _DLL
#      pragma comment (lib, "glut_md.lib")    /* link with Win32 GLUT lib */
#     else
#      pragma comment (lib, "glut_mt.lib")    /* link with Win32 GLUT lib */
#     endif
#    else
#      pragma comment (lib, "glut_ml.lib")    /* link with Win32 GLUT lib */
#    endif
#   else
#    ifdef _MT
#     ifdef _DLL
#      pragma comment (lib, "glut_mdd.lib")    /* link with Win32 GLUT lib */
#     else
#      pragma comment (lib, "glut_mtd.lib")    /* link with Win32 GLUT lib */
#     endif
#    else
#      pragma comment (lib, "glut_mld.lib")    /* link with Win32 GLUT lib */
#    endif
#   endif
# endif
#endif
...
#  pragma warning (disable:4505)  /* VC++ 8.0 version of above warning. */
# endif
...
#  else
    /* Current definition */
#   ifdef _DLL
/*#    define _CRTIMP __declspec(dllimport)  変更  */
#   else
#    define _CRTIMP
#   endif
#  endif
...
#  define GLUTAPI extern				/* 変更： __declspec(dllexport) */
# else
#  ifdef _DLL
#   define GLUTAPI extern				/* 変更： __declspec(dllimport) */
#  else
...
#include <stdlib.h>
/* extern _CRTIMP void __cdecl exit(int); 変更： .NETと互換にする　*/
# endif
#else
/* non-Win32 case. */
...
/* 追加：カレントウィンドウのウィンドウハンドラを取得 */
GLUTAPI void* APIENTRY _glutGetHWND( void );

/* 追加：ウィンドウの終了処理時のイベントハンドラ設定 */
GLUTAPI void APIENTRY _glutDestroyFunc( void (GLUTCALLBACK *func)( void ) );

/* 追加：ウィンドウのアクティブ・非アクティブ時のイベントハンドラ設定 */
GLUTAPI void APIENTRY _glutActivateFunc( void (GLUTCALLBACK *func)( int state ) );
